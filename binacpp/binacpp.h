...
public:
    ...
    static timestamp_t get_current_server_time();
    ...
    static void cancel_order(const char *symbol,
        long orderId,
        const char *origClientOrderId,
        const char *newClientOrderId, timestamp_t timestamp,
        long recvWindow,
        Json::Value &json_result
    );
    ...
    static bool IsError(Json::Value& result);
};
